using ContentPersonalization.Service.Common;
using ContentPersonalization.Service.Common.Core.Helpers;
...
namespace ContentPersonalization.Service.Setup
{
    public static class PersistenceSetup
    {
        ...
        public static IServiceCollection AddContextInfraestructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            string? CdmiContextConnectionString = configuration.GetConnectionString(nameof(ContentDbContext));
