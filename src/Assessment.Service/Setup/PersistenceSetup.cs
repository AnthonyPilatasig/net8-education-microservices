...
using Assessment.Service.Common.Core.Helpers;
using Assessment.Service.Common.Core.Persistence;
using Assessment.Service.Common.Core.Wrapper;
...
namespace Assessment.Service.Setup
{
    public static class PersistenceSetup
    {
        ...
        public static IServiceCollection AddContextInfraestructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            #region Assessment Context

            string? CdmiContextConnectionString = configuration.GetConnectionString(nameof(AssessmentDbContext));
