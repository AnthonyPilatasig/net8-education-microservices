using CompetencyMapping.Service.Common;
using CompetencyMapping.Service.Common.Core.Helpers;
using CompetencyMapping.Service.Common.Core.Persistence;
using CompetencyMapping.Service.Common.Core.Wrapper;
...
namespace ContentPersonalization.Service.Setup
{
    public static class PersistenceSetup
    {
        ...
        public static IServiceCollection AddContextInfraestructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            #region Competency Context

            string? CdmiContextConnectionString = configuration.GetConnectionString(nameof(CompetencyDbContext));
