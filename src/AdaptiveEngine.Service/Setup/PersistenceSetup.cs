using AdaptiveEngine.Service.Common;
using AdaptiveEngine.Service.Common.Core.Helpers;
using AdaptiveEngine.Service.Common.Core.Persistence;
using AdaptiveEngine.Service.Common.Core.Wrapper;
...
namespace AdaptiveEngine.Service.Setup
{
    public static class PersistenceSetup
    {
        ...
        public static IServiceCollection AddContextInfraestructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            #region AdaptiveEngine Context

            string? CdmiContextConnectionString = configuration.GetConnectionString(nameof(AdaptiveEngineDbContext));
            services.AddDbContext<AdaptiveEngineDbContext>(options =>
            {
                if (loggingEnabled)
                {
