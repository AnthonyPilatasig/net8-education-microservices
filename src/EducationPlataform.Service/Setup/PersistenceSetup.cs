using EducationPlataform.Service.Common;
using EducationPlataform.Service.Common.Core.Helpers;
using EducationPlataform.Service.Common.Core.Persistence;
using EducationPlataform.Service.Common.Core.Wrapper;
...
namespace EducationPlataform.Service.Setup
{
    public static class PersistenceSetup
    {
        ...
        public static IServiceCollection AddContextInfraestructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            string? CdmiContextConnectionString = configuration.GetConnectionString(nameof(EducationDbContext));
